<template>
    <div :id="id" class="flex items-start gap-2.5">
        <img class="w-8 h-8 rounded-full" src="/profile.jpg" :alt="sender">
        <div class="flex flex-col gap-1 w-full max-w-[320px]">
            <div class="flex flex-col leading-1.5 px-4 pb-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl dark:bg-gray-700">
...
<script setup lang="ts">
    defineProps<{value?: string, id: string, sentAt: string, updatedAt?: string, sender: string}>()
</script>