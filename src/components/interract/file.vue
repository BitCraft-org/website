<template>
    <div class="flex items-start gap-2.5">
        <img class="w-8 h-8 rounded-full" src="/profile.jpg" alt="profile-photo">
        <div class="flex flex-col gap-1">
            <div class="flex flex-col w-full max-w-[320px] leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl dark:bg-gray-700">
                ...
                <div v-if="msgType == 'file+text'" class="flex flex-col leading-1.5 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl dark:bg-gray-700">
                    <p class="text-sm font-normal py-2.5 text-gray-900 dark:text-white">{{ value }}</p>
...
<script setup lang="ts">
    defineProps<{
        value?: string, blob:string, size: string, 
        id: string, sentAt: string, updatedAt?: string, 
        sender: string, fileType: string, msgType: string
    }>()
</script>
